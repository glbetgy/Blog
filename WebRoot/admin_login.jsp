...
<html>
  ...
  <body>
    	  <table width="100%">
                    ...
                    <table height="100%">
                        ...
                        <tr>
                            ...
                            <td valign="top" id="form">
                                <form action="logon.do" method="post" name="form1">
                                    <table valign="top" width="50%">
                                        ...
                                        <tr class="bt" align="center"><td>&nbsp;<input type="submit" value="登陆" /></td><td>&nbsp;<a href="register_user.jsp">注册</a></td></tr>
                                    </table>
                                </form>
                            </td>
                            <td rowspan="5">&nbsp;</td>
            ...
            <!-- 底部部分 -->
            <tr id="login_bot"><td colspan="2"><p>博客网站</p></td></tr>
        </table>
  </body>
</html>
